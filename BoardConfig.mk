...
DEVICE_PATH := device/infinix/X699C
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := X699C
...
BOARD_KERNEL_IMAGE_NAME := boot.lzma
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/boot.lzma
